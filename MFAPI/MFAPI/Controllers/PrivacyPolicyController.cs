...
namespace MFAPI.Controllers
{
    ...
    public class PrivacyPolicyController : ControllerBase
    {
        ...
        public PrivacyPolicyController(SqlDbContext context)
        {
            _context = context;
        }
        [HttpGet]
        [Route("Get")]
        public async Task<ActionResult<IEnumerable<PrivacyPolicy>>> Get()
        {
            return await _context.tblPrivacyPolicy.ToListAsync();
        }
        [HttpPost]
        [Route("Insert")]
        ...
        [HttpGet]
        [Route("Edit/{id}")]
        public async Task<PrivacyPolicy> Edit(int id)
        {
            return await _context.tblPrivacyPolicy.FindAsync(id);
        }
        [HttpPut]
        [Route("Update/{id}")]
